# SmartPermits — Tabel sintetic al acoperirii funcționalităților

**Cerințe funcționale (CF):** 41 acoperite complet / 1 parțial / 1 neacoperite — din 43.

**Cerințe nefuncționale (CNF):** 12 acoperite complet / 1 parțial / 0 neacoperite — din 13.

## Cerințe funcționale (CF1–CF43)

| ID | Descriere | Test(e) | Status |
|----|-----------|---------|--------|
...
## Cerințe nefuncționale (CNF1–CNF13)
